...
pos=0				# determine whether to enter position, 0-NotEnter 1-Enter
num=0				# Keep track of the row currently on
percentchange=[]	# result of our trades
...
print()
print("Results for " +stock +" going back to "+str(df.index[0])+", Sample size: "+str(ng+nl)+" trade")
